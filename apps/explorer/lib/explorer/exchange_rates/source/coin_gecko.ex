defmodule Explorer.ExchangeRates.Source.CoinGecko do
  ...
  def format_data(%{"market_data" => _} = json_data) do
    ...
    percent_change_24h = get_price_change_percentage(market_data)
  ...
  defp get_price_change_percentage(market_data) do
    if market_data["price_change_percentage_24h"] do
      to_decimal(market_data["price_change_percentage_24h"])
