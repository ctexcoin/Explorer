defmodule BlockScoutWeb.Account.WatchlistAddressController do
  ...
  def new(conn, _params) do
    ...
    render(conn, "form.html", method: :create, watchlist_address: empty_watchlist_address(), user: current_user)
  end
  ...
  def create(conn, %{"watchlist_address" => wa_params}) do
    ...
    case WatchlistAddress.create(params_to_attributes(wa_params, current_user.watchlist_id)) do
      ...
      {:error, changeset} ->
        render(conn, "form.html", method: :create, watchlist_address: changeset, user: current_user)
    end
  end
  ...
  def edit(conn, %{"id" => id}) do
    ...
    case WatchlistAddress.get_watchlist_address_by_id_and_watchlist_id(id, current_user.watchlist_id) do
      ...
      %WatchlistAddress{} = watchlist_address ->
        render(conn, "form.html", method: :update, watchlist_address: WatchlistAddress.changeset(watchlist_address), user: current_user)
    end
  end
  ...
  def update(conn, %{"id" => id, "watchlist_address" => wa_params}) do
    ...
    case wa_params
      ...
      {:error, changeset} ->
        render(conn, "form.html", method: :update, watchlist_address: changeset, user: current_user)
    end
  end
