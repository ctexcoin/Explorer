defmodule BlockScoutWeb.Account.CustomABIController do
  ...
  def new(conn, _params) do
    ...
    render(conn, "form.html", method: :create, custom_abi: empty_custom_abi(), user: current_user)
  end
  ...
  def create(conn, %{"custom_abi" => custom_abi}) do
    ...
    case CustomABI.create(%{
      ...
      {:error, invalid_custom_abi} ->
        render(conn, "form.html", method: :create, custom_abi: invalid_custom_abi, user: current_user)
    end
  end
  ...
  def index(conn, _params) do
    ...
    render(conn, "index.html", custom_abis: CustomABI.get_custom_abis_by_identity_id(current_user.id), user: current_user)
  end
  ...
  def edit(conn, %{"id" => id}) do
    ...
    case CustomABI.get_custom_abi_by_id_and_identity_id(id, current_user.id) do
      ...
      %CustomABI{} = custom_abi ->
        render(conn, "form.html", method: :update, custom_abi: CustomABI.changeset_without_constraints(custom_abi), user: current_user)
    end
  end
  ...
  def update(conn, %{"id" => id, "custom_abi" => %{"abi" => abi, "name" => name, "address_hash" => address_hash}}) do
    ...
    case CustomABI.update(%{
      ...
      {:error, %Changeset{} = custom_abi} ->
        render(conn, "form.html", method: :update, custom_abi: custom_abi, user: current_user)
