defmodule BlockScoutWeb.Account.PublicTagsRequestController do
  ...
  def index(conn, _params) do
    ...
    Logger.debug("The value of current_user is #{current_user.id}...")
  ...
  def create(conn, %{"public_tags_request" => public_tags_request}) do
    ...
    case PublicTagsRequest.create(%{
      ...
      {:error, invalid_public_tags_request} ->
        render(conn, "form.html", method: :create, public_tags_request: invalid_public_tags_request, user: current_user)
    end
  end
  ...
  def update(conn, %{
    ...
    case PublicTagsRequest.update(%{
      ...
      {:error, %Changeset{} = public_tags_request} ->
        render(conn, "form.html", method: :update, public_tags_request: public_tags_request, user: current_user)
