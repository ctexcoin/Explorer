defmodule BlockScoutWeb.LayoutView do
  ...
  alias BlockScoutWeb.AdminRouter.Helpers, as: RoutesAdmin
  ...
  def get_list_menu(type) do
    Menu.get_menu_show(type)
  end

  def get_eth_value do
    exchange_rate = Market.get_exchange_rate(Explorer.coin()) || Token.null()
    exchange_rate.usd_value
  end

  def getpercent_change_24h do
    exchange_rate = Market.get_exchange_rate(Explorer.coin()) || Token.null()
    if is_nil(exchange_rate.percent_change_24h) do
      0
    else
      exchange_rate.percent_change_24h
    end
  end
end
