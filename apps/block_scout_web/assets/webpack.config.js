...
const appJs =
  {
    entry: {
      ...
      'admin-delete-item-handler': './js/pages/admin/delete_item_handler.js',
      'editor': './js/editor.js',
      'admin-custom': './js/pages/admin/custom.js',
      'admin-tokens-manager': './js/pages/admin/tokens-manager.js',
    },
    output: {
      filename: '[name].js',
      path: path.resolve(__dirname, '../priv/static/js')
